...
KERNEL_FILENAME = "offload_parfor_TransformerBlock_207.kernel"
...
def test_tree_rewriter_applies_optimize_TransformerBlock207_tkernel():
    assert_tree_rewriter_applies(KERNEL_FILENAME, reduction_chunks=8)


def test_tree_rewriter_changes_TransformerBlock207_glsl():
