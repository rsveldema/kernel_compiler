...
KERNEL_FILENAME = "offload_parfor_vecmath_474.kernel"
...
def test_tree_rewriter_applies_optimize_vecmath474_tkernel():
    assert_tree_rewriter_applies(KERNEL_FILENAME, reduction_chunks=8)


def test_tree_rewriter_changes_vecmath474_glsl():
