...
KERNEL_FILENAME = "offload_parfor_vecmath_531.kernel"
...
def test_tree_rewriter_applies_optimize_vecmath531_tkernel():
    assert_tree_rewriter_applies(KERNEL_FILENAME, reduction_chunks=8)


def test_tree_rewriter_changes_vecmath531_glsl():
