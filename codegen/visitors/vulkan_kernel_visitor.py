...
class VulkanKernelVisitor(Visitor):
    ...
    def _prepend_emit(self, line: str) -> None:
        oldlines = self._lines
        self._lines = [line]
        for l in oldlines:
    ...
    def visit_program(self, node: Program) -> str:
        ...
        # 1. vulkanizer generates loop vars in kernel file       
        ...
        """ generated by vulkanizer, this code is obsoleted:
        ...
        for name, expr in self._constexpr_defines:
            self._prepend_emit(f"#define {name} {expr}")
        self._prepend_emit("#version 450")
